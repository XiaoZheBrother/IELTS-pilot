...
<template>
  <div class="app-shell">
    ...
    <header v-if="!focusMode" class="site-header">
      ...
      <div class="header-tools" data-testid="utility-nav"><span class="local-status"><i aria-hidden="true" /> 本地数据</span><RouterLink to="/updates">更新</RouterLink><RouterLink to="/settings">设置</RouterLink><RouterLink to="/about">关于</RouterLink></div>
    </header>
